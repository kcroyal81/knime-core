...
public class EnhWEBP674_PartialWizardPageReexecution extends WorkflowTestCase {
	...
	public void loadWorklfowAndExecuteToFirstPage() throws Exception {
		...
		IllegalStateException exception = assertThrows(IllegalStateException.class,
				() -> wec.reexecuteCurrentPage(null, Collections.emptyMap()));
	...
	public void testReexecuteSinglePageLoadValuesAndStepNextWhileReexcutionInProgress() {
		...
		IllegalStateException exception = assertThrows(IllegalStateException.class,
				() -> wec.reexecuteCurrentPage(createNodeIDSuffix(7), createWizardPageInput(0)));
	...
	public void testStepBackWhileInSinglePageReexecution() {
		...
		wec.reexecuteCurrentPage(createNodeIDSuffix(6), Collections.emptyMap());
	...
	private void reexecuteSinglePageAndKeepExecuting(WizardExecutionController wec) {
		wec.reexecuteCurrentPage(createNodeIDSuffix(7), createWizardPageInput(400000));
		assertThat(wec.hasCurrentWizardPage(), is(true));
