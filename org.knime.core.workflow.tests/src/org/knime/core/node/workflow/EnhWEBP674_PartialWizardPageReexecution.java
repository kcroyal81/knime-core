...
public class EnhWEBP674_PartialWizardPageReexecution extends WorkflowTestCase {
	...
	public void testReexecuteSinglePage() {
		SinglePageWebResourceController sec = reexecuteSinglePageTillExecuted();
	...
	public void testReexecuteSinglePageAndGetPageWithStillExecutingNodes() {
		SinglePageWebResourceController sec = reexecuteSinglePageAndKeepExecuting();
		WizardPageContent pageContent = sec.getWizardPage();
		assertThat(pageContent.getInfoMap().size(), is(4));
	 ...
	 */
	@Test
	public void testInvalidSinglePageExecutionController() {
		SinglePageWebResourceController sec = reexecuteSinglePageTillExecuted();
		WizardExecutionController wec = getManager().setAndGetWizardExecutionController();
	...
	private SinglePageWebResourceController reexecuteSinglePageAndKeepExecuting() {
		WorkflowManager wfm = getManager();
		WizardExecutionController wec = wfm.setAndGetWizardExecutionController();
	...
	private SinglePageWebResourceController reexecuteSinglePageTillExecuted() {
		WorkflowManager wfm = getManager();
		WizardExecutionController wec = wfm.setAndGetWizardExecutionController();
